...
**Blender Wiggle** is a complete rewrite of the original [Blender Wiggle Bones Add-on](https://github.com/shteeve3d/blender-wiggle) by Steve Miller, offering improved features and stability. While far from perfect, it definitely gets the job done!

## Fork Notice

This project is a fork of the original [Blender Add-on by Steve Miller](https://github.com/shteeve3d/blender-wiggle-2). Modifications have been made to fix compatibility issues with newer Blender versions, new features for bone collision, along with code cleanup.
